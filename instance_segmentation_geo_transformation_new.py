...
import utils.clusterAlgorithms
...
def my_app(cfg: DictConfig) -> None:
    ...
    for i, batch in enumerate(tqdm(loader)):
        ...
        with (torch.no_grad()):
            ...
            segmentation_mask_img_array = np.array(segmentation_mask_img)
            plt.imshow(segmentation_mask_img_array)
            plt.show()
            ...
            filtered_segmentation_mask_img_array = np.array(filtered_segmentation_mask_img)
            plt.imshow(filtered_segmentation_mask_img_array)
            plt.show()
